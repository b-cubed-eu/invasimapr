...
# Prebuilt inputs live in vignettes/_data (build-ignored, not shipped).
# Resolve the path regardless of the article's working directory.
.in <- c("_data/invasimapr_vignettes.rds",
         "../_data/invasimapr_vignettes.rds",
         "vignettes/_data/invasimapr_vignettes.rds")
inputs <- readRDS(.in[file.exists(.in)][1])
